...
- The user's local OpenViking-style LLM and embedding server is available at `http://127.0.0.1:8745`; it is optimized for OpenViking-style LLM and embedding requests and may be a preferred local model backend for Brick integrations.
